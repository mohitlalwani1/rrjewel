        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-sm text-gray-600 hover:text-amber-900 transition-colors">Get In Touch</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-amber-900 transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-amber-900 transition-colors">Shipping policy</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-amber-900 transition-colors">Terms of Conditions</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-amber-900 transition-colors">Contact information</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-amber-900 transition-colors">Return and Refund policy</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <div className="mt-6">
              <a href="#" className="inline-flex items-center justify-center w-10 h-10 bg-gray-200 rounded-full hover:bg-amber-900 hover:text-white transition-colors">
